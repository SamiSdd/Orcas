<%@ Page Inherits="form_validation" %>
<!DOCTYPE HTML>
<html>
	<head>
		<style type="text/css">
            form > div:after {  clear: both; content: "."; display: block; height: 0; line-height: 0; visibility: hidden; }
            form > div > span { display: block; float: left; margin: 10px 0; width: 110px; }
